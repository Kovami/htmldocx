...
/*
 * The body-only variant of a corpus document: no headers or footers and no
 * footnotes or endnotes. Those differ from Word by design (plain HTML has no
 * page furniture; a browser prints notes at the end, Word at the page foot),
...
function bodyOnly(string $in, string $out): bool
{
    ...
    $strip = $xpath->query('//w:sectPr/w:headerReference | //w:sectPr/w:footerReference | //w:sectPr/w:titlePg | //w:r[w:footnoteReference or w:endnoteReference]');
