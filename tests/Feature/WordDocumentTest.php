...
it('paints a table styled from Word\'s gallery', function () {
    ...
    expect($html)
        ...
        ->toContain('color: #ffffff; font-kerning: none; margin: 0 0 10.67px 0; line-height: 1.317; position: relative; top: -0.71px;">Показатель</div>')
...
it('keeps Word\'s footnotes and endnotes with their marks and text', function () {
    ...
    expect($html)
        ...
        ->toContain('font-size: 13.33px; color: #000000; font-kerning: none; margin: 0 0 0 0; line-height: 1.221;">Сноска, как её пишет Word.')
